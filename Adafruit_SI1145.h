...
#define SI1145_PARAM_ALSVISADCMISC_VISLRANGE 0x00
...
#define SI1145_PARAM_ADCGAIN_1   0x00 
#define SI1145_PARAM_ADCGAIN_2   0x01 
#define SI1145_PARAM_ADCGAIN_4   0x02 
#define SI1145_PARAM_ADCGAIN_16  0x04 
#define SI1145_PARAM_ADCGAIN_64  0x06 
#define SI1145_PARAM_ADCGAIN_128 0x07 
...
class Adafruit_SI1145  {
 public:
  ...
  void     writeVisSen(boolean high);
  void     writeVisAdcGain(uint8_t gain);
  void     writeVisAdcCnt(uint8_t cnt);
